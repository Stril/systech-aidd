...
class MemoryStorage:
    ...
    def add_user(self, user: User) -> None:
        ...
        if is_new:
            logger.info(
                f"memory_storage|user_added|user_id={user.user_id}|username={user.username}"
            )
        else:
    ...
    def clear_conversation(self, user_id: int) -> None:
        ...
        if user_id in self._conversations:
            ...
            logger.info(
                f"memory_storage|conversation_cleared|user_id={user_id}|cleared={cleared_count}"
            )
        else:
    ...
    def get_metrics(self) -> dict[str, int]:
        ...
        metrics = {
            ...
            "total_messages": sum(
                conv.get_message_count() for conv in self._conversations.values()
            ),
